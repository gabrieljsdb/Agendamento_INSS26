...
export default function MyAppointments() {
  ...
  const canReschedule = (createdAtStr: string) => {
    // Regra: Pode remarcar 30 minutos após o agendamento ser feito
    // Nota: O usuário pediu "podendo realizar remarção 30 minutos depois do agendamento ser feito"
    // Isso geralmente significa que há um período de carência ou uma restrição.
    // Vou assumir que ele quer permitir remarcação SOMENTE após 30 min da criação.
